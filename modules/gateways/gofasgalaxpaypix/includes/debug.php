...
if($debug_or_log){
	...
	if($transID){
		$debug_result['Transações da fatura'] = 'Transação existente: '.$transID;
	}
	else {
...
if($debug){
	echo '<div id="debugDiv"  onfocus="select_all_and_copy(this)" onclick="select_all_and_copy(this)"><br>',print_r($debug_result,true),'</div></pre>';
}